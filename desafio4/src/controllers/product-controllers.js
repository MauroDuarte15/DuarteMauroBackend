...
const getAll = async (req, res) => {
  try {
    const data = await new Container("../../products.json").getAll();
...
const getById = async (req, res) => {
  try {
    ...
    const data = await new Container("../../products.json").getById(id);
...
const save = async (req, res) => {
  try {
    ...
    await new Container("../../products.json").save(newProduct);
...
const updateById = async (req, res) => {
  try {
    ...
    //actualizar
    await new Container("../../products.json").updateById(id, newData);
...
const deleteById = async (req, res) => {
  try {
    ...
    await new Container("../../products.json").deleteById(id);
